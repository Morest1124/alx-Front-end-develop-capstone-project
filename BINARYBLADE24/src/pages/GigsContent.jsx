                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="communication"
                      name="communication"
                      value={gigData.communication}
                      onChange={handleInputChange}
                      className="w-full px-4 py-2 border rounded-lg"
                      placeholder="e.g., Via platform chat"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <img
                src={
                  gigData.gigImage
                    ? URL.createObjectURL(gigData.gigImage)
                    : "https://via.placeholder.com/300x200.png?text=Your+Gig+Image"
                }
                alt="Gig Thumbnail"
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  <p className="text-lg font-bold text-green-600">
                    {pricingModel === "package"
                      ? `R${gigData.basicPrice || "0"}`
                      : `R${gigData.hourlyRate || "0"}/hr`}
                  </p>
